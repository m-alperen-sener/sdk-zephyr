 ...
 * In the second run central reconnects twice: after cold boot from flash, and again
 * after the peripheral performs a soft stack reset (bt_disable/bt_enable) while
 * using extended directed advertising with RPA.
 */
